...
export default async function InstagramInsights({ searchParams }: { searchParams: Promise<{ tab?:string; metric?:string; error?:string; refreshed?:string; connected?:string }> }) {
