...
export type Database = {
  public: {
    Tables: {
      ...
      status_history: { Row: { id: string; owner_id: string; content_item_id: string; from_status: ContentStatus | null; to_status: ContentStatus; reason: string | null; created_at: string }; Insert: { owner_id: string; content_item_id: string; from_status?: ContentStatus | null; to_status: ContentStatus; reason?: string | null }; Update: never; Relationships: [] };
